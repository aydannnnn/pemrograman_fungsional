...
add_expense = lambda expenses, new_expense: expenses + [new_expense]
...
generate_expenses_report = lambda expenses: (f"{expense['tanggal']}: {sum(item['jumlah'] for item in expenses if item['tanggal'] == expense['tanggal'])}" for expense in expenses)
